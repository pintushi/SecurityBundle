...
namespace Pintushi\Bundle\SecurityBundle\Acl\Extension;
...
use Pintushi\Bundle\SecurityBundle\Acl\Exception\InvalidAclMaskException;
...
abstract class AbstractAccessLevelAclExtension extends AbstractAclExtension
{
    ...
    protected function isAccessGranted($triggeredMask, $object, TokenInterface $securityToken)
    {
        ...
        if ($securityToken instanceof OrganizationContextTokenInterface) {
            ...
            if ($this->isAccessDeniedByOrganizationContext($object, $organization, $accessLevel)) {
                return false;
            }
        }
     ...
     *
     * @param object                            $object
     * @param OrganizationInterface             $organizatoin
    ...
    protected function isAccessDeniedByOrganizationContext(
        ...
        return
            ...
            && $objectOrganizationId !== $organization->getId();
    }
