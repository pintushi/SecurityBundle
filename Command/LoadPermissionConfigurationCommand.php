...
namespace Pintushi\Bundle\SecurityBundle\Command;
...
{
    const NAME = 'pintushi:permission:configuration:load';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $manager = $this->getContainer()->get('pintushi.acl.permission_manager');
    ...
    protected function isManageableEntityClass($entityClass)
    {
        if (!$this->doctrineHelper) {
            $this->doctrineHelper = $this->getContainer()->get(DoctrineHelper::class);
        }
