...
use Pintushi\Bundle\SecurityBundle\AccessRule\AclAccessRule;
use Pintushi\Bundle\SecurityBundle\AccessRule\ChainAccessRule;
use Pintushi\Bundle\SecurityBundle\AccessRule\Criteria;
...
{
    public const CONTEXT = 'pintushi_access_rule.context';
    ...
    private function getChainAccessRule(ContainerInterface $container): ChainAccessRule
    {
        if (!$this->chainAccessRule) {
            $this->chainAccessRule = $container->get('pintushi_security.access_rule.chain_access_rule');
        }
