...
class AclConfigurationPass implements CompilerPassInterface
{
    ...
    const NEW_ACL_PROVIDER = 'pintushi_security.acl.provider';

    const DEFAULT_ACL_VOTER = 'security.acl.voter.basic_permissions';

    const ACL_EXTENSION_SELECTOR = 'pintushi_security.acl.extension_selector';
    const ACL_EXTENSION_TAG = 'pintushi_security.acl.extension';
