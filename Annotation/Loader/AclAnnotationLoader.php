...
{
    const ANNOTATION_CLASS = 'Pintushi\Bundle\SecurityBundle\Annotation\Acl';
    const ANCESTOR_CLASS   = 'Pintushi\Bundle\SecurityBundle\Annotation\AclAncestor';
