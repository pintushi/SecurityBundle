...
use Pintushi\Bundle\SecurityBundle\Exception\NotManageableEntityException;
use Pintushi\Bundle\SecurityBundle\ORM\DoctrineHelper;
use Pintushi\Bundle\SecurityBundle\Entity\Permission;
use Pintushi\Bundle\SecurityBundle\Entity\PermissionEntity;
use Pintushi\Bundle\SecurityBundle\Exception\MissedRequiredOptionException;
...
class PermissionConfigurationBuilder
{
     ...
     * @param EntityRepository $permissionRepository
     */
    public function __construct(ValidatorInterface $validator, PermissionRepository $permissionRepository)
    {
    ...
    protected function buildPermissionEntities(array $configuration)
    {
        ...
        foreach ($configuration as $entityName) {
            ...
            if (!array_key_exists($entityNameNormalized, $this->processedEntities)) {
                $permissionEntity = $this->permissionRepository->findOneBy(['name' => $entityName]);
