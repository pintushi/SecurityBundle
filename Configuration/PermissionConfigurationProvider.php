...
{
    const ROOT_NODE_NAME = 'pintushi_permissions';
    ...
    /** @var string */
    protected $configPath = 'Resources/config/app/permissions.yml';
    ...
    {
        $configLoader = new CumulativeConfigLoader('pintushi_security', new YamlCumulativeFileLoader($this->configPath));
